...
#'
#' @format A data frame with 5 observations and 13 variables \describe{
...
#' SLGA Terrain Product Information
#'
#' A data frame containing information about the terrain products available from
#' the Soil and Landscape Grid of Australia.
#'
#' All datasets are projected in EPSG:4326 (WGS84). Grid parameters have been
#' retrieved from metadata viewable with WCS DescribeCoverage requests.
#'
#' @format A data frame with 18 observations and 12 variables \describe{
#' \item{Product}{Product Name}
#' \item{Code}{Product code}
#' \item{xmin}{left bounding longitude in decimal degrees}
#' \item{ymin}{bottom latitude in decimal degrees}
...
#lga_terrain_info <-
# data.frame(
#   "Name"     = c('Prescott Index', 'Net Radiation [January]', 'Net Radiation [July]',
...
#   "Code"     = c('PSIND', 'NRJAN', 'NRJUL', 'TSJAN', 'TSJUL', 'SLPPC', 'SLMPC',
...
#usethis::use_data(slga_terrain_info, overwrite = TRUE)
